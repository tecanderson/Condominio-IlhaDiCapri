...
import {NativeModules, useWindowDimensions,SafeAreaView} from 'react-native';
...
export default function NivelInferior1({navigation}) {
let initAdres = 12 ;/** Endereço inicial de leitura do clp */
let adresQtd = 4;/** quantidade de endereços a serem lidos consequentemente
quantidade de thread a ser criada */
/**
 *  mesmo IP dos tanques 02 e 03
 */
...
let DI0 = 'Di15';/** level HH */
let DI1 = 'Di14';/** level H */
let DI2 = 'Di13';/** level L  */
let DI3 = 'Di12';/** level LL */
const {Di13:Di02,Di14:Di01,Di15:Di00,Di12:Di03,
      setDi13:setDi02,setDi14:setDi01,setDi15:setDi00,setDi12:setDi03
    } = useCoilsContext();
...
{/**
  ...
  */setDi03(data[DI3])}
  ...
  return (
    ...
    <LevelLd height={height} width={width} LL={LL} L={L} HH={HH} LH={LH} TK={'TQ01'}/>
