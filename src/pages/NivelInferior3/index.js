...
import LevelLe from '../../../assets/LevelLe';

export default function NivelInferior3({navigation}) {
let initAdres = 20 ;/** Endereço inicial de leitura do clp */
let adresQtd = 4;/** quantidade de endereços a serem lidos consequentemente
quantidade de thread a ser criada */
/**
 * mesmo IP dos tanques 02 e 01
 */
...
let DI0 = 'Di23';/** level HH */
let DI1 = 'Di22';/** level H */
let DI2 = 'Di21';/** level L  */
let DI3 = 'Di20';/** level LL */
const {Di21:Di02,Di22:Di01,Di23:Di00,Di20:Di03,
      setDi21:setDi02,setDi22:setDi01,setDi23:setDi00,setDi20:setDi03
    } = useCoilsContext();
...
{/**
  ...
  */setDi03(data[DI3])}
  ...
  return (
    ...
    <LevelLe height={height} width={width} LL={LL} L={L} HH={HH} LH={LH} TK={'TQ03'}/>
