...
export default function NivelInferior4({navigation}) {
...
/**
 * o tanque 4 muda de clp e consequentemente muda o ip 
 */
let Host = "192.168.0.4" ;/** Endereço do modulo clp de onde seram lidos os endereços */
...
{/**
  ...
  */setDi03(data[DI3])}
  ...
  return (
    ...
    <LevelLe height={height} width={width} LL={LL} L={L} HH={HH} LH={LH} TK={'TQ04'}/>
